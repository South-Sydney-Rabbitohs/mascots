...
export const characters: Character[] = [
  // Reggie is the lead character — always first
  {
    id: 'reggie',
    slug: 'reggie',
    firstName: 'Reggie',
    ...
    relatedCharacters: ['jack', 'ruby', 'scarlett', 'oliver'],
    accentColor: '#007A3D',
    cardImage: '',
  ...
  },
  {
    ...
    relatedCharacters: ['reggie', 'ruby', 'scarlett', 'oliver'],
    accentColor: '#C8102E',
    cardImage: '',
    heroImage: '',
    thumbImage: '',
  ...
  },
  {
    ...
    relatedCharacters: ['reggie', 'jack', 'scarlett', 'oliver'],
    accentColor: '#51319C',
    cardImage: '',
    heroImage: '',
    thumbImage: '',
  ...
  },
  {
    ...
    relatedCharacters: ['reggie', 'jack', 'ruby', 'scarlett'],
    accentColor: '#0D4F2A',
    cardImage: '',
    heroImage: '',
    thumbImage: '',
