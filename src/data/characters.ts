...
export const characters: Character[] = [
  // Order: Reggie, Scarlett, Jack, Ruby, Oliver
  {
    ...
    tagline: 'South Sydney legend, proud Poppy and the one who started it all.',
    bio: [
    ...
    species: 'Rabbit',
    lives: 'With the the Mascot Family in Redfern',
    ...
    bestMoments: [
      {
        ...
        image: '',
        altText: 'Reggie proudly wearing his South Sydney Rabbitohs scarf at a packed stadium',
      },
      {
        ...
        image: '',
        altText: 'Reggie taking a selfie with fans at a Rabbitohs game',
      },
      {
        ...
        image: '',
        altText: 'Reggie doing his famous Reggie Roll to fire up the South Sydney crowd',
      },
    ],
    activityIds: [],
    available: true,
  ...
  },
  {
    ...
    tagline: "Fastest in the family and loudest in the stand!",
    bio: [
    ...
    bestMoments: [
      {
        ...
        image: '',
        altText: 'Young Scarlett as ball girl alongside Grandad Reggie at a Rabbitohs game',
      },
      {
        ...
        image: '',
        altText: "Scarlett coaching Ruby's junior footy team from the sideline",
      },
      {
        ...
        image: '',
        altText: 'Scarlett cheering loudly in the stands at a South Sydney Rabbitohs game',
      },
    ],
    activityIds: [],
    available: true,
  ...
  },
  {
    ...
    tagline: "Cap backwards, full speed — aerodynamic. It's science!",
    bio: [
    ...
    bestMoments: [
      {
        ...
        image: '',
        altText: 'Jack singing with a huge grin on his face',
      },
      {
        ...
        image: '',
        altText: 'Jack running at top speed down the field',
      },
      {
        ...
        image: '',
        altText: 'Jack leaping to give an enthusiastic high-five to a fan',
      },
    ],
  ...
  },
  {
    ...
    tagline: "Quiet confidence, a great pass and a heart full of Red & Green.",
    bio: [
    ...
    bestMoments: [
      {
        ...
        image: '',
        altText: 'Ruby passing the ball to her teammate with a big smile',
      },
      {
        ...
        image: '',
        altText: 'Ruby standing tall and confident on the footy field',
      },
      {
        ...
        image: '',
        altText: 'Ruby making a big tackle to change the momentum of the game',
      },
    ],
    activityIds: [],
    available: true,
  ...
  },
  {
    ...
    tagline: "New to the Rabbitohs, but heart and soul all in!",
    bio: [
    ...
    bestMoments: [
      {
        ...
        image: '',
        altText: 'Oliver looking thoughtful while watching a Rabbitohs game',
      },
      {
        ...
        image: '',
        altText: 'Oliver sharing his famous stew wisdom with the Rabbit family',
      },
      {
        ...
        image: '',
        altText: 'Oliver proudly showing off something he built with his paws',
      },
    ],
    activityIds: [],
    available: true,
